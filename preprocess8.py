...
parser.add_argument('-train_src', default='./data1/train.src',
                    help="Path to the training source data")
parser.add_argument('-train_tgt', default='./data1/train.tgt',
                    help="Path to the training target data")
parser.add_argument('-valid_src', default='./data1/valid.src',
                    help="Path to the validation source data")
parser.add_argument('-valid_tgt', default='./data1/valid.tgt',
                     help="Path to the validation target data")

parser.add_argument('-save_data', default='./data8/',
